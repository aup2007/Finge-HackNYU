  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 flex flex-col items-center justify-center p-4 md:p-8">
      ...
      <div className="w-full max-w-6xl relative h-48 mb-12">
        <Card className="absolute left-4 top-0 transform -rotate-6 w-72 p-4 bg-white/90 backdrop-blur">
          <div className="flex items-start justify-between">
            <div>
              <h3 className="font-serif text-2xl">Apple Inc.</h3>
              <div className="flex items-center gap-2">
                <span className="font-mono">AAPL</span>
                <span className="text-red-500">-5.59 (2.40%)</span>
              </div>
            </div>
        ...
        <Card className="absolute right-4 top-4 transform rotate-6 w-72 p-4 bg-white/90 backdrop-blur">
          <div className="flex items-start justify-between">
            <div>
              <h3 className="font-serif text-2xl">Netflix Inc.</h3>
              <div className="flex items-center gap-2">
                <span className="font-mono">NFLX</span>
                <span className="text-green-500">+0.98 (0.097%)</span>
              </div>
            </div>
            <div className="bg-black rounded-full p-2">
              <img
      ...
      <div className="text-center space-y-6">
        <h1 className="font-serif text-5xl md:text-7xl">Hinge for stocks.</h1>
        <div className="space-y-2">
          <h2 className="font-serif text-4xl md:text-6xl">
            Fin<span className="text-slate-400">/</span>ge
          </h2>
          <p className="text-xl text-slate-600">the app for investors.</p>
        </div>
        <Button variant="outline" size="lg" className="text-xl px-8 py-6 mt-8 rounded-full border-2">
          try it out now
